...
router.get(
  ...
  user_controller.getAddressById
);
...
router.get(
  "/getAllgetInTouchById/:id",
  getInTouch_controller.getAllgetInTouchById
);
...
router.get(
  ...
  category_controller.getAllCategoryforAdmin
);
...
router.post(
  "/getAllProductApiforFilter",
  product_controller.getAllProductApiforFilter
);
router.get(
  "/getCatSizeColorBrandPrice",
  product_controller.getCatSizeColorBrandPrice
);
router.get("/searchProduct", product_controller.searchProduct);
router.get(
  "/getProductByCategoryId/:categoryId",
  product_controller.getProductByCategoryId
);
...
router.get(
  "/getCountOfCartAndWishListOfUser/:userId",
  cart_controller.getCountOfCartAndWishListOfUser
);
